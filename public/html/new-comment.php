                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <div>
                                    <p style="font-size: 0;"><label>Project id: </label><?php echo $project_id; ?></p>
                                    <p style="font-size: 0;"><label>Commentable id: </label><?php echo $commentable_id; ?></p>
                                    <p style="font-size: 0;"><label>Creator email: </label><?php echo $creator['data']['email']; ?></p>
                                </div>
